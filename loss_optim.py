...
class CombSingle(object):
    ...
    def __init__(self,
                 ...
                 test_indx=range(16), tune_indx=(88,)):
        ...
        for mtype in mtypes:
            if mtype not in self.hist:
                self.hist[mtype] = self.data.test_classif_cv(
                    ...
                    gene_list=self.loss_genes, test_indx=self.test_indx,
                    tune_indx=self.tune_indx, final_fit=False
                    )
...
class LossSimple(object):
    ...
    def __init__(self,
                 cdata, loss_gene, classif=classif.Lasso,
...
class LossOptimizer(object):
    ...
    def __init__(self, cdata_list, loss_gene):
        ...
        self.lasso_clx = [classif.Lasso([loss_gene], x)
...
class MultiKBTL(object):
    ...
    def crossval_score(self, expr_list, mut_list, cv_list):
        ...
        return np.percentile(cv_scores, 25)
