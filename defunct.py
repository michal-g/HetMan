...
class Defunct(object):
    ...
    def __init__(self, mut_expr, mut_gene=None):
        ...
        self.covar_type = 'spherical'

    def infer_cnv(self):
        norm = StandardScaler()
        mix = GaussianMixture(
            n_components=3, covariance_type=self.covar_type, n_init=50,
            weights_init=[0.1,0.8,0.1], means_init=[(-1,-1), (0,0), (1,1)]
            )
    ...
    def plot_infer(self):
        ...
        for i, (mean, covar, colour) in enumerate(
            ...
            elif self.covar_type == 'spherical':
                pass
